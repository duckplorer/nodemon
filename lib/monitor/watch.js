...
bus.on('restart', function (files) {
  // If this is a manual restart (e.g. user typed 'rs') there are no files.
  // Cancel any pending delayed restart so the manual restart is immediate
  // and not followed by a spurious debounced restart from a prior file change.
